    ...
    if year_select == '2018년':
        ...
        if jisu_select == '사회 지수':
            ...
            with c4:
                ...
                text = '''공공시설의 인구 비율에서 전국의 평균과 시군의 격차를 이용하여 양극화 지수를 개발하였습니다.\n
인구비율의 격차가 클수록 전국 평균보다 낮다는 뜻으로 양극화지수가 높아짐을 의미합니다.
...
- 병원, 주차장, 도서관, 공공체육시설 서비스권역 내 인구 비율
                ...
                st.text_area('내용', value=text, height=200)
                # st.markdown("""
            ...
            with c4:
                ...
                st.markdown("""
                *부동산과 소득과 소비 데이터에서 전국의 평균과 시군의 격차를 이용하여 양극화 지수를 개발하였습니다. (단, GRDP는 지역내총생산이므로 서울 =100 기준으로 설정) 격차가 클수록 전국 평균보다 낮다는 뜻으로 양극화지수가 높아짐을 의미합니다.* \n
                \n *: 전국 = 100 기준* \n
                \n <자산>
                \n - 주택보급률 \n
                \n - 노후주택비율 \n
            ...
            with c4:
                ...
                st.markdown("""
                \n *: 사회영역과 경제영역을 산술평균하여 종합 지수를 산출하였습니다. 양극화 지수가 높을수록 전국의 기준보다 낮다는 뜻이며, 양극화 지수가 낮을수록 전국의 기준보다 높다는 뜻입니다. 서로의 격차를 이용하여 충청권의 양극화 지수가 얼마나 값이 차이나는지 확인할 수 있습니다.* \n
                \n""", unsafe_allow_html=True)
            ...
            with c4:
                ...
                st.markdown("""
                \n *: 각 년도별 평균을 기준으로 평균보다 높은 값은 양극화라고 판단하였습니다. 양극화가 1인 경우 전국평균에 비해 공공시설의 인구비율이 높으며, 주택가격, 1인당 소비가격, GRDP의 값이 높다는 뜻입니다. 즉, 인구가 다른 시,군에 비해 많이 사는 도시입니다. 양극화가 0인 경우 전국 평균에 비해 공공시설의 인구비율이 낮으며, 주택가격, 1인당 소비가격, GRDP의 값이 낮다는 뜻입니다. 즉 인구가 다른 시,군에 비해 적게 사는 도시입니다.* \n
                \n""", unsafe_allow_html=True)
